...
// INDEX
// GET /comments
router.get('/cards/:id/comments', requireToken, (req, res, next) => {
  Comment.find()
    .then(comments => {
...
// router.get('/cards/:id/comments/:id', requireToken, (req, res, next) => {
...
// CREATE
// POST /comments
router.post('/cards/:id/comments-create', requireToken, (req, res, next) => {
...
router.patch('/cards/:id/comments/:id', requireToken, removeBlanks, (req, res, next) => {
...
router.delete('/cards/:id/comments/:id', requireToken, (req, res, next) => {
  Comment.findById(req.params.id)
    .then(handle404)
    .then(comment => {
